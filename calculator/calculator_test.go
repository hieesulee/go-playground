...
import (
	...
	"github.com/hieesume/go-playground/calculator"
)
...
func TestAdd(t *testing.T) {
	...
	for _, table := range tables {
		if total, err := calculator.Add(table.x, table.y); err != nil && err.Error() != table.e {
...
func TestSubtract(t *testing.T) {
	...
	for _, table := range tables {
		if total, err := calculator.Subtract(table.x, table.y); err != nil && err.Error() != table.e {
...
func TestMultiply(t *testing.T) {
	...
	for _, table := range tables {
		if total, err := calculator.Multiply(table.x, table.y); err != nil && err.Error() != table.e {
...
func TestDivide(t *testing.T) {
	...
	for _, table := range tables {
		if total, err := calculator.Divide(table.x, table.y); err != nil && err.Error() != table.e {
